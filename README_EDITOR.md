...
pyinstaller --noconsole --onefile --icon=Gemini_Generated_Image_t2ldymt2ldymt2ld.png --add-data "cat_background_1764666718697.png;." --add-data "Gemini_Generated_Image_t2ldymt2ldymt2ld.png;." --name="Tutu" md_editor_qt.py
```
